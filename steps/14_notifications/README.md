...
Créer les notifications et préférences utiles aux familles.

## Sous-étapes

1. `01_modeles_preferences.md` : Préférences
2. `02_evenements_notifications.md` : Événements
3. `03_api_notifications.md` : API notifications
4. `04_cloturer_etape.md` : Clôture notifications
